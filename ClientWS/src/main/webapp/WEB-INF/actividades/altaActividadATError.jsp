...
<body>
	...
	<main>
		<div id="container">
			...
			<h5 class="MensajeError">Ya existe el nombre de Actividad
				elejido, ingrese otro por favor.</h5>
            ...
            String [] dep=(String [])request.getAttribute("departamentos");%>
				...
				<fieldset class="subjet">
					<legend>Seleccione una o mas Categorias</legend>
					<div class="subjet">
						<ul>
							<%
