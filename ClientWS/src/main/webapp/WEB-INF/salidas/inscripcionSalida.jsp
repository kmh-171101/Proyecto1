			...
			<form action="salidas?direccionar=inscribir" method="POST"
				...
				<table class="tabla">
	      	   ...
	      	   %> <input type="hidden" id="actelegida" name="actiSelect"
					...
					<tr>
						<td>Costo por turista:</td>
						<td><input type="text" id="turistas2" name="costo"
							value=<%=request.getAttribute("costo")%> disabled="disabled" /></td>
					</tr>
					<%} %>
					<tr>
					...
					<tr>
						<td><input type="number" id="turistas" name="turistas"
							placeholder="0" value=0 min="0" max="1000" /></td>
