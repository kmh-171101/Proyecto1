...
<body onload='javascript:hideTable()'>
			...
			<form action="usuario?parametro=altaUsr" method="POST"
				...
				<div class="derecha">
					<label for="nickname"></label> <input type="text"
						placeholder="Nickname" name="Nickname" id="nickname_input"
						required>
				</div>
				<div class="izquierda">
				...
				<div class="izquierda">
					<label for="contraseña2"></label> <input type="password"
						placeholder="Confirme contraseña" name="contrasea2"
						id="contrasea2" required>
				</div>
				<div class="derecha">
				...
				<div class="botones">
					<div class="submit">
						<a href="home?direccionar=cierre" class="cancelar"><input
	...
	<script>
		...
		function validarFormulario(evento) {
		  ...
		  const c2 = document.getElementById('contrasea2').value;
